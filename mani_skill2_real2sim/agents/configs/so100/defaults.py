...
class SO100DefaultConfig:
    def __init__(self) -> None:
        self.urdf_path = (
            "{ASSET_DIR}/descriptions/so100/so100.urdf"
        )
        ...
        self.arm_stiffness = [1169.78, 730.0, 808.46, 1229.12, 1272.27]
        self.arm_damping = [330.0, 180.0, 152.12, 309.62, 201.04]

        self.arm_force_limit = [200, 200, 100, 100, 100]
